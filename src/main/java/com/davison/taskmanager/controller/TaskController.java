...
public class TaskController {
    ...
    public ResponseEntity<List<TaskResponse>> listarTarefas(
            @Parameter(description = "Filtrar por status (PENDENTE, EM_ANDAMENTO, CONCLUIDA)") @RequestParam(required = false) String status,
            @Parameter(description = "Ordenação (ex: prazo,asc ou titulo,desc)", example = "prazo,asc") @RequestParam(defaultValue = "prazo,asc") String sort,
